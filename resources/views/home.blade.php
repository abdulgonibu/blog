...
<body>
                    ...
                    @foreach ($portfolies as $portfolio)
                        <div class="col-md-4 mb-3">
                            <div class="p-3 shadow ">
                                <img src="{{ !empty($portfolio->image) ? url('public/upload/logo_images/' . $portfolio->image) : url('public/upload/no-image.png') }}"
    ...
    <div class="mobile-navbar hidden h-[102vh] bg-white absolute top-0 left-0 text-left shadow overflow-y">
        <div class="text-center pt-2 flex items-center mt-3 ml-5">
            @foreach ($logos as $logo)
                <a href="{{ route('home') }}">
                    <img src="{{ !empty($logo->image) ? url('public/upload/logo_images/' . $logo->image) : url('upload/no-image.png') }}"
                        height="130px" width="120px">
