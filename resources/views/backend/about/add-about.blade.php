                    ...
                    <section class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3> Add Slider
                                    <a class="btn btn-success float-right btn-sm" href="{{ route('abouts.view') }}"><i
                                            class="fa fa-list"></i> About List</a>
                                </h3>
                            </div><!-- /.card-body -->
                            <div class="card-body">
                                <form method="post" action="{{ route('abouts.store') }}" id="myForm"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <textarea name="about_text" id="summernote" cols="30" class="form-control" rows="10"
