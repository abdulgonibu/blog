                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3> Add Portfolio Image
                                <a class="btn btn-success float-right btn-sm" href="{{ route('portfolies.show')}}"><i class="fa fa-list"></i> Logo List</a>
                            </h3>
                        </div><!-- /.card-body -->
                        <div class="card-body">
                            <form method="post" action="{{ route('portfolies.store')}}" id="myForm" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
