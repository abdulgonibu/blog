     ...
     <div class="sidebar">
         ...
         <nav class="mt-2">
             <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                 ...
                 <li
                     class="nav-item {{ request()->is('logos/view', 'sliders/view', 'categories/view', 'portfolies/view', 'videos/view', 'contacts/communicate', 'abouts/view', 'sliders/add', 'contacts/view') ? 'menu-open' : '' }}">
                     <a href="#" class="nav-link">
